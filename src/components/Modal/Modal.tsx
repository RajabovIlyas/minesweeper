...
const Modal:FC<ModalProps> = ({showModal, saveId, setShowModal, onSave, children}) => {
  const onClose = () => {
    setShowModal(false)
  }
  return showModal && (
    <>
      ...
      >
        <div className='relative w-auto my-6 mx-auto max-w-3xl w-full p-5'>
          <div
            ...
            <div className='dark:bg-neutral-800 dark:border-neutral-700 flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b'>
              <button
